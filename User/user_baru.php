...
if( empty( $_SESSION['iduser'] ) ){
	...
	if(isset($_REQUEST['submit'])){
		...
		$sql = mysqli_query($konek, "INSERT INTO user VALUES('','$username',md5('$password'),'$admin','$fullname')");
...
<form class="form-horizontal" method="post" action="admin.php?hlm=master&aksi=baru" role="form" autocomplete="off">
