...
if( empty( $_SESSION['iduser'] ) ){
	...
	if( isset( $_REQUEST['submit'] )){
		...
		$sql = mysqli_query($konek, "INSERT INTO jenis_bayar VALUES('$tapel','$tingkat','$jumlah')");
...
<hr>
<form method="post" action="admin.php?hlm=master&sub=jenis&aksi=baru" class="form-horizontal" role="form" autocomplete="off">
