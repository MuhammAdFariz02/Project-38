...
if( empty( $_SESSION['iduser'] ) ){
	...
	if( isset( $_REQUEST['sub'] )){
		...
		if(isset($_REQUEST['aksi'])){
			...
			$sql = mysqli_query($konek, "SELECT iduser,username,admin,fullname FROM user ORDER BY iduser");
