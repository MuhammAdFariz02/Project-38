...
if( empty( $_SESSION['iduser'] ) ){
	...
	if( isset( $_REQUEST['submit'] )){
		...
		$sql = mysqli_query($konek, "INSERT INTO tapel VALUES('','$tapel')");
...
<hr>
<form method="post" action="admin.php?hlm=master&sub=tapel&aksi=baru" class="form-horizontal" role="form" autocomplete="off">
