...
if( empty( $_SESSION['iduser'] ) ){
   ...
   $sql = mysqli_query($konek, "SELECT s.nis,s.nama,k.kelas,p.bulan,p.jumlah FROM (santri s INNER JOIN kelas k ON s.nis = k.nis) LEFT JOIN pembayaran p ON s.nis = p.nis ORDER BY k.kelas, s.nis");
